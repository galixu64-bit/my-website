...
const translations = {
    zh: {
        ...
        'visitWebsite': '访问网站',
        'download': '下载',
        'downloadLinkNotConfigured': 'dragbit "{name}" 的下载链接尚未配置。',
        'viewDetails': '查看详情',
        'comments': '评论',
        'uploadedBy': '发布者',
        'uploader': '上传者：',
        ...
        'usernamePlaceholderOptional': '输入用户名（可选，不填则使用邮箱前缀）',
        'loginPlaceholder': '输入邮箱或用户名',
    ...
    en: {
        ...
        'viewAllResources': 'View All Uploaded Resources',
        'viewAllResourcesSubtitle': 'View all resources uploaded by users',
        'profile': 'Profile',
